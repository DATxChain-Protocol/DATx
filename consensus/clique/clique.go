...
// DATx testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // DATx address of the signing key
...
// Author implements consensus.Engine, returning the DATx address recovered
