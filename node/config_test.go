...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gdatx.ipc", false, filepath.Join(os.TempDir(), "gdatx.ipc")},
		{"data", "gdatx.ipc", false, "data/gdatx.ipc"},
		{"data", "./gdatx.ipc", false, "./gdatx.ipc"},
		{"data", "/gdatx.ipc", false, "/gdatx.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gdatx.ipc", true, `\\.\pipe\gdatx.ipc`},
		{"data", "gdatx.ipc", true, `\\.\pipe\gdatx.ipc`},
		{"data", `\\.\pipe\gdatx.ipc`, true, `\\.\pipe\gdatx.ipc`},
	}
