...
func testGetNodeData(t *testing.T, protocol int) {
	...
	hashes := []common.Hash{}
	for _, key := range pm.chaindb.(*datxdb.MemDatabase).Keys() {
	...
	statedb, _ := datxdb.NewMemDatabase()
...
// Tests that post datx protocol handshake, DAO fork-enabled clients also execute
