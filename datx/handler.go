...
import (
	...
	"github.com/DATxChain-Protocol/DATx/datx/fetcher"
...
func NewProtocolManager(config *params.ChainConfig, mode downloader.SyncMode, networkId uint64, mux *event.TypeMux, txpool txPool, engine consensus.Engine, blockchain *core.BlockChain, chaindb datxdb.Database) (*ProtocolManager, error) {
...
// handle is the callback invoked to manage the life cycle of an datx peer. When
