...
// `datx_getFilterChanges` polling method that is also used for log filters.
//
// https://github.com/DATx/wiki/wiki/JSON-RPC#datx_newpendingtransactionfilter
...
// It is part of the filter package since polling goes with datx_getFilterChanges.
//
// https://github.com/DATx/wiki/wiki/JSON-RPC#datx_newblockfilter
...
//
// https://github.com/DATx/wiki/wiki/JSON-RPC#datx_newfilter
...
//
// https://github.com/DATx/wiki/wiki/JSON-RPC#datx_getlogs
...
//
// https://github.com/DATx/wiki/wiki/JSON-RPC#datx_uninstallfilter
...
//
// https://github.com/DATx/wiki/wiki/JSON-RPC#datx_getfilterlogs
...
//
// https://github.com/DATx/wiki/wiki/JSON-RPC#datx_getfilterchanges
