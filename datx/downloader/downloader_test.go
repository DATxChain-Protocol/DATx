...
type downloadTester struct {
	...
	stateDb datxdb.Database // Database used by the tester for syncing from peers
	peerDb  datxdb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	testdb, _ := datxdb.NewMemDatabase()
	...
	tester.stateDb, _ = datxdb.NewMemDatabase()
