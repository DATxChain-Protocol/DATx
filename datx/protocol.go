...
var ProtocolName = "datx"

// Supported versions of the datx protocol (first is primary).
...
// datx protocol message codes
const (
	// Protocol messages belonging to datx/62
	StatusMsg          = 0x00
	...
	// Protocol messages belonging to datx/63
	GetNodeDataMsg = 0x0d
	NodeDataMsg    = 0x0e
	GetReceiptsMsg = 0x0f
	ReceiptsMsg    = 0x10
