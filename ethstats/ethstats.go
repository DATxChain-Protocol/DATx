...
// Service implements an DATx netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server        // Peer-to-peer server to retrieve networking infos
	eth    *eth.DATx      // Full DATx service if monitoring a full node
	les    *les.LightDATx // Light DATx service if monitoring a light node
...
func New(url string, ethServ *eth.DATx, lesServ *les.LightDATx) (*Service, error) {
