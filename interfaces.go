...
// Package DATx defines interfaces for interacting with Ethereum.
package DATx
...
type CallMsg struct {
	...
	GasPrice *big.Int        // uno <-> gas exchange ratio
	Value    *big.Int        // amount of uno sent along with the call
