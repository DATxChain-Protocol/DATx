...
type accessTestFn func(db datxdb.Database, bhash common.Hash, number uint64) light.OdrRequest

func TestBlockAccessLes1(t *testing.T) { testAccess(t, 1, tfBlockAccess) }

func TestBlockAccessLes2(t *testing.T) { testAccess(t, 2, tfBlockAccess) }

func tfBlockAccess(db datxdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db datxdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db datxdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db datxdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
