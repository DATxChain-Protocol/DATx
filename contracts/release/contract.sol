...
// ReleaseOracle is an DATx contract to store the current and previous
// versions of the go-datx implementation. Its goal is to allow Gdatx to
// check for new releases automatically without the need to consult a central
// repository.
//
// The contract takes a vote based approach on both assigning authorised signers
// as well as signing off on new Gdatx releases.
//
...
contract ReleaseOracle {
  ...
  // Version is the version details of a particular Gdatx release
  struct Version {
  ...
  // updateSigner marks a vote for changing the status of an DATx user, either
