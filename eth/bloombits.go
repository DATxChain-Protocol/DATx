...
const (
	// bloomServiceThreads is the number of goroutines used globally by an DATx
...
func (eth *DATx) startBloomHandlers() {
...
// for the DATx header bloom filters, permitting blazing fast filtering.
