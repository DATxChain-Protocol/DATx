...
// PublicDATxAPI provides an API to access DATx full node-related
// information.
type PublicDATxAPI struct {
	e *DATx
}

// NewPublicDATxAPI creates a new DATx protocol API for full nodes.
func NewPublicDATxAPI(e *DATx) *PublicDATxAPI {
	return &PublicDATxAPI{e}
}

// Validator is the address that mining signer
func (api *PublicDATxAPI) Validator() (common.Address, error) {
	return api.e.Validator()
}

// Coinbase is the address that mining rewards will be send to
func (api *PublicDATxAPI) Coinbase() (common.Address, error) {
	return api.e.Coinbase()
}

// Hashrate returns the POW hashrate
func (api *PublicDATxAPI) Hashrate() hexutil.Uint64 {
...
func NewPublicMinerAPI(e *DATx) *PublicMinerAPI {
...
func NewPrivateMinerAPI(e *DATx) *PrivateMinerAPI {
...
// PrivateAdminAPI is the collection of DATx full node-related APIs
...
// admin methods of the DATx service.
func NewPrivateAdminAPI(eth *DATx) *PrivateAdminAPI {
...
// PublicDebugAPI is the collection of DATx full node APIs exposed
...
// related public debug methods of the DATx service.
func NewPublicDebugAPI(eth *DATx) *PublicDebugAPI {
...
// PrivateDebugAPI is the collection of DATx full node APIs exposed over
...
// private debug methods of the DATx service.
func NewPrivateDebugAPI(config *params.ChainConfig, eth *DATx) *PrivateDebugAPI {
