...
// swarm.
//
// Internally this backend uses the already exposed API endpoints of the DATx
...
func NewContractBackend(apiBackend ethapi.Backend) *ContractBackend {
	return &ContractBackend{
		eapi:  ethapi.NewPublicDATxAPI(apiBackend),
...
// ContractCall implements bind.ContractCaller executing an DATx contract
// call with the specified data as the input. The pending flag requests execution
// against the pending block, not the stable head of the chain.
func (b *ContractBackend) CallContract(ctx context.Context, msg datx.CallMsg, blockNum *big.Int) ([]byte, error) {
...
// call with the specified data as the input. The pending flag requests execution
// against the pending block, not the stable head of the chain.
func (b *ContractBackend) PendingCallContract(ctx context.Context, msg datx.CallMsg) ([]byte, error) {
	out, err := b.bcapi.Call(ctx, toCallArgs(msg), rpc.PendingBlockNumber)
	return out, err
}

func toCallArgs(msg datx.CallMsg) ethapi.CallArgs {
...
func (b *ContractBackend) EstimateGas(ctx context.Context, msg datx.CallMsg) (*big.Int, error) {
