...
func newTester(t *testing.T, confOverride func(*datx.Config)) *tester {
	...
	if err = stack.Register(func(ctx *node.ServiceContext) (node.Service, error) { return datx.New(ctx, ethConf) }); err != nil {
