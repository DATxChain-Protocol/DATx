...
func (req *TrieRequest) StoreResult(db datxdb.Database) {
	req.Proof.Store(db)
}
...
// StoreResult stores the retrieved data in local database
func (req *CodeRequest) StoreResult(db datxdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *BlockRequest) StoreResult(db datxdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *ReceiptsRequest) StoreResult(db datxdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *ChtRequest) StoreResult(db datxdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *BloomRequest) StoreResult(db datxdb.Database) {
