...
import (
	...
	"github.com/DATx-Protocol/go-DATx/contracts/release"
...
func defaultNodeConfig() node.Config {
	...
	cfg.HTTPModules = append(cfg.HTTPModules, "datx", "shh")
	cfg.WSModules = append(cfg.WSModules, "datx", "shh")
...
func makeFullNode(ctx *cli.Context) *node.Node {
	...
	if err := stack.Register(func(ctx *node.ServiceContext) (node.Service, error) {
		...
		utils.Fatalf("Failed to register the Gdatx release oracle service: %v", err)
	}
	return stack
}
