...
// setting up a new or managing an existing DATx private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your DATx private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new DATx network down to  |")
	...
	log.Info("Administering DATx network", "name", w.network)
