...
const (
	...
	subscribeTimeout     = 5 * time.Second  // overall timeout datx_subscribe, rpc_modules calls
)
...
// EthSubscribe registers a subscripion under the "datx" namespace.
func (c *Client) EthSubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	return c.Subscribe(ctx, "datx", channel, args...)
}
