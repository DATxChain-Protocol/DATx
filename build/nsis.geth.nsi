...
# 1. install gdatx for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gdatx
# 5. create gdatx, attach and uninstall start menu entries
...
function .onInit
  # make vars are global for all users since gdatx is installed global
