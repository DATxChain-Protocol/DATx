...
type Strategy struct {
	...
	AutoCashThreshold    *big.Int      // threshold that triggers autocash (uno)
	AutoDepositInterval  time.Duration // default interval for autocash
	AutoDepositThreshold *big.Int      // threshold that triggers autodeposit (uno)
	AutoDepositBuffer    *big.Int      // buffer that is surplus for fork protection etc (uno)
}
