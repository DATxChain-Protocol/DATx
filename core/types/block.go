...
// Package types contains data types related to DATx consensus.
package types
...
// Header represents a block header in the DATx blockchain.
type Header struct {
...
// a block's data contents (transactions and uncles) togdatxer.
type Body struct {
	Transactions []*Transaction
	Uncles       []*Header
}

// Block represents an entire block in the DATx blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the DATx RLP block format.
