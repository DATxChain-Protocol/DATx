...
// that address/topic, and binary AND-ing those vectors togdatxer.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them togdatxer
				var orVector []byte
...
// the reuested retrieval queue to be serviced togdatxer with other sessions.
//
