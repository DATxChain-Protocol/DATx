...
func makeTestState() (Database, *datxdb.MemDatabase, common.Hash, []*testAccount) {
	// Create an empty state
	mem, _ := datxdb.NewMemDatabase()
	db := NewDatabase(mem)
...
// account array.
func checkStateAccounts(t *testing.T, db datxdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db datxdb.Database, root common.Hash) error {
...
func checkStateConsistency(db datxdb.Database, root common.Hash) error {
