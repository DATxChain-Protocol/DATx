...
// GetBalanceAt returns the uno balance of the given account.
...
// GetPendingBalanceAt returns the uno balance of the given account in the pending state.
